...
Comment2:='Черный ферзь недвусмысленно поглядывает на белого короля. Воспользуйтесь этим.';
Uroven:=1;
end;
if (partNum=2) then
begin
...
Comment2:='Король черных прикрыт лишь пешечной цепью. На него нацелены две батареи белых:(слон и ферзь),(ладья и ферзь).Сметите эту цепь используя жертву.';
Uroven:=1;
end;
if (partNum=3) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Линии e и d в центре принадлежат белым. В лагере черых слаб пункт e6. Используйте это.';
Uroven:=1;
end;
if (partNum=4) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Черным можно развиться с темпами, чтобы еще больше овладеть инициативой. После чего положение белых критическое.';
Uroven:=1;
end;
if (partNum=5) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Пешечное окружение черного короля слабо. Разрушьте его для вторжения фигур белых.';
Uroven:=1;
end;
if (partNum=6) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Положение черных фигур неустойчвое. Осуществите размен с оптимальной выгодой.';
Uroven:=1;
end;
if (partNum=7) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Под взглядом мощной фигуры провисает ладья. Используйте это. Стоит отметить что у белых не обеспечен король. ';
Uroven:=1;
end;
if (partNum=8) then
begin
...
Moves := 'd4-b6';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='В лагере черных фигуры стеснены. Используйте это.';
Uroven:=1;
end;
if (partNum=9) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Воспользуйтесь угрозой мата.';
Uroven:=1;
end;
if (partNum=10) then
begin
...
Moves := 'c3-h3';
Comment:= 'Ход черных. Найдите оптимальный вариант.' ;
Comment2:='Используйте отсутствие форточки.';
Uroven:=1;
end;
if (partNum=11) then
begin
...
Moves := 'f4-h4';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте ограниченное положение белого короля.';
Uroven:=1;
end;
if (partNum=12) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Попробуйте выиграть на связке.';
Uroven:=1;
end;
if (partNum=13) then
begin
...
Moves := 'g3-g8';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте открытое положение черного короля.';
Uroven:=1;
end;
if (partNum=15) then
begin
...
Moves := 'c4-f4';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Черный ферзь выполняет много функций. Используйте это.';
Uroven:=1;
end;
...
Moves := 'd5-e7';
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Используйте слабость пункта g7.';
Uroven:=1;
end;
if (partNum=18) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Король черных в клетке. Испльзуйте это.';
Uroven:=1;
end;
if (partNum=19) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат в 2 хода.';
Uroven:=1;
end;
if (partNum=20) then
begin
...
Moves := 'c5-a3';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Белый король зажат. Используйте это';
Uroven:=1;
end;
if (partNum=22) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поищите матовую комбинацию.';
Uroven:=1;
end;
if (partNum=24) then
begin
...
Moves := 'd6-c4';
Comment:= 'Ход черных. Найдите оптимальный вариант.' ;
Comment2:='Главная фигура белого войска забралась далеко. Воспользуйтесь этим.';
Uroven:=1;
end;
if (partNum=26) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='В воздухе пахнет матом.';
Uroven:=1;
end;
if (partNum=27) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Грозит вскрытый шах. Надо его не допустить.';
Uroven:=1;
end;
if (partNum=28) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Возьмите крепость черных прямым штурмом.';
Uroven:=1;
end;
if (partNum=29) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте ослабление белого короля.';
Uroven:=1;
end;
if (partNum=30) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте слабость восьмой горизонтали.';
Uroven:=1;
end;
if (partNum=31) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте отвечение защитника.';
Uroven:=1;
end;
if (partNum=32) then
begin
...
Comment2:='Ничья достигается патом.';
Uroven:=1;
end;
if (partNum=34) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Заманите короля черных под вилку.';
Uroven:=1;
end;
if (partNum=35) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте вскрытую угрозу.';
Uroven:=1;
end;
if (partNum=36) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Используйте дальнобойность ферзя.';
Uroven:=1;
end;
if (partNum=37) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите эффектную жертву.';
Uroven:=1;
end;
if (partNum=40) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте вскрытый шах.';
Uroven:=1;
end;
if (partNum=41) then
begin
...
Moves := 'd7-b5';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте отвлечение защитника.';
Uroven:=1;
end;
if (partNum=42) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте завлечение под связку.';
Uroven:=1;
end;
...
Moves := 'b4-e7';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Надо напасть с темпом.';
Uroven:=1;
end;
if (partNum=44) then
begin
...
Moves := 'd5-e3';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Ферзь белых неустойчив. Это можно исползовать.';
Uroven:=1;
end;
if (partNum=45) then
begin
...
Moves := 'f3:e5';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Разбейте пешечный центр.';
Uroven:=1;
end;
if (partNum=48) then
begin
...
Moves := 'e2-e7';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Уберите ладью с угрозой.';
Uroven:=1;
end;
if (partNum=49) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Проведите пешку в ферзи.';
Uroven:=1;
end;
if (partNum=52) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Взломайте крепость белых прямым ударом.';
Uroven:=1;
end;
...
Moves := 'e1:e6';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Уберите защитника слабых полей.';
Uroven:=1;
end;
if (partNum=55) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.  Сделайте ничью.';
Comment2:='Сделайте ничью вечным шахом.';
Uroven:=1;
end;
if (partNum=64) then
begin
...
Moves := 'b7-b8';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте геометрию.';
Uroven:=1;
end;
if (partNum=65) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Уничтожьте защитника слабых полей.';
Uroven:=1;
end;
if (partNum=66) then
begin
...
Moves := 'd2-h6 ';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Сделайте промежуточный ход с угрозой.';
Uroven:=1;
end;
if (partNum=71) then
begin
...
Moves := 'd1-e1';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте отвлечение.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат, пожертвовав коня.';
Uroven:=1;
end;
if (partNum=78) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Решить позицию путем прямой матовой атаки.';
Uroven:=1;
end;
if (partNum=80) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат с жертвой.';
Uroven:=1;
end;
if (partNum=82) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте недозащищенность белой фигуры.';
Uroven:=1;
end;
if (partNum=84) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Расчитайте вариант приводящий к выигрышу качества.';
Uroven:=1;
end;
if (partNum=85) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте слабость последней горизонтали';
Uroven:=1;
end;
if (partNum=86) then
begin
...
Moves := 'd6-f5';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Скакун готов к решающему прыжку.';
Uroven:=1;
end;
if (partNum=88) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Сплетите матовую сеть.';
Uroven:=1;
end;
if (partNum=89) then
begin
...
Moves := 'b3:c4';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Темпово уйдите из под боя.';
Uroven:=1;
end;
if (partNum=92) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Пожертвуйте ладью во благо.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Введите в атаку слона.';
Uroven:=1;
end;
if (partNum=94) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Используйте угрозу проведения пешки в ферзи.';
Uroven:=1;
end;
if (partNum=97) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Откройте линии для выигрыша ладьи.';
Uroven:=1;
end;
if (partNum=98) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант. Сделайте ничью.';
Comment2:='Сделайте ничью используя патовую идею.';
Uroven:=1;
end;
if (partNum=100) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте неожиданный шах.';
Uroven:=1;
end;
if (partNum=101) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Все тяжелые фигуры белых должны участвовать в атаке.';
Uroven:=1;
end;
if (partNum=102) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте слабость поля e8.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат после прямого удара.';
Uroven:=1;
end;
if (partNum=104) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Подорвите защитную пешечную цепь черных.';
Uroven:=1;
end;
if (partNum=107) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Сплетите матовую сеть вокруг короля черных.';
Uroven:=1;
end;
if (partNum=108) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Сделайте промежуточный ход.';
Uroven:=1;
end;
if (partNum=109) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Разрушьте королевскую крепость.';
Uroven:=1;
end;
if (partNum=110) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Разрушьте пешечное прекрытие черного короля.';
Uroven:=1;
end;
if (partNum=111) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Исполните промежуточный ход слоном.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант. Сделайте ничью.';
Comment2:='Обеспечьте ничью патом.';
Uroven:=1;
end;
if (partNum=114) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Используйте слабость 8-ой горизонтали.';
Uroven:=1;
end;
if (partNum=117) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Уберите главную фигуру защиты черных.';
Uroven:=1;
end;
if (partNum=118) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Нанесите удар по плохо защищенному пункту f7.';
Uroven:=1;
end;
if (partNum=119) then
begin
...
Moves := 'a7-a8';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте отвлечение ладьи.';
Uroven:=1;
end;
if (partNum=120) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Усильте позицию черного ферзя.';
Uroven:=1;
end;
if (partNum=121) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Не забудьте про неожиданный шах.';
Uroven:=1;
end;
if (partNum=122) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте недостаточную защиту ладьи на d8.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Сплетите матовую сеть вокруг короля белых.';
Uroven:=1;
end;
if (partNum=124) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте слабые пункты f7 и e6.';
Uroven:=1;
end;
if (partNum=128) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте ограниченность черного короля.';
Uroven:=1;
end;
if (partNum=130) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте завлечение.';
Uroven:=1;
end;
if (partNum=132) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отразите угрозы черных неожиданным отскоком коня.';
Uroven:=1;
end;
if (partNum=134) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Сплетите неожиданную матовую конструкцию.';
Uroven:=1;
end;
if (partNum=135) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант. Сделайте ничью.';
Comment2:='Используйте угрозу для зажатого черного короля.';
Uroven:=1;
end;
if (partNum=138) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь незащищенностью ладьи d2.';
Uroven:=1;
end;
if (partNum=139) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте открытость белого короля.';
Uroven:=1;
end;
if (partNum=140) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте эффективную жертву ферзя.';
Uroven:=1;
end;
if (partNum=142) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Сплетите матовую сеть вокруг черного короля.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Перейдите в выигранный пешечный эндшпиль.';
Uroven:=1;
end;
if (partNum=145) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.' ;
Comment2:='Осуществите захват через открытую линию.';
Uroven:=1;
end;
if (partNum=147) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Вытащите короля белых наружу.';
Uroven:=1;
end;
if (partNum=148) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отвлеките коня черных.';
Uroven:=1;
end;
if (partNum=149) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Король черных в матовой сетке. Надо подтянуть коня.';
Uroven:=1;
end;
if (partNum=150) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='В динамичной позиции расчитайте взятие пешки до конца.';
Uroven:=1;
end;
if (partNum=151) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Возможно ничего страшного что слон f3 под боем?';
Uroven:=1;
end;
if (partNum=152) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подведите ферзя ближе к вражескому королю.';
Uroven:=1;
end;
if (partNum=154) then
begin
...
Moves := 'c2-c8';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте перекрытие.';
Uroven:=1;
end;
if (partNum=155) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте завлечение под шах.';
Uroven:=1;
end;
if (partNum=157) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте завлечение белого ферзя.';
Uroven:=1;
end;
if (partNum=158) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите эффектную жертву ферзя.';
Uroven:=1;
end;
if (partNum=159) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Пешечные окончания легко выигрываются.';
Uroven:=1;
end;
if (partNum=160) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте необеспеченное положение белого короля.';
Uroven:=1;
end;
if (partNum=163) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте геометрию на черного ферзя и короля.';
Uroven:=1;
end;
if (partNum=164) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте завлечение под вилку.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Заматуйте короля, отдав коня.';
Uroven:=1;
end;
if (partNum=168) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Конь и слон белых матуют.';
Uroven:=1;
end;
if (partNum=169) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Сьешьте на f7 с матовой атакой.';
Uroven:=1;
end;
if (partNum=170) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Победите маневрами ферзя с шахами.';
Uroven:=1;
end;
if (partNum=171) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Белые в матовой клетке.';
Uroven:=1;
end;
if (partNum=172) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Заматуйте, пожертвовав ладью.';
Uroven:=1;
end;
if (partNum=173) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Вскройте линию g с матом.';
Uroven:=1;
end;
if (partNum=174) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Завлеките под двойной шах.';
Uroven:=1;
end;
if (partNum=177) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Выиграйте ферзя, пожертвовав качество.';
Uroven:=1;
end;
if (partNum=178) then
begin
...
Moves := 'f7-d5';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отступите слоном с многочисленными угрозами.';
Uroven:=1;
end;
if (partNum=179) then
begin
...
Moves := 'c5-d4';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Только одно отступление слона оптимальное.';
Uroven:=1;
end;
if (partNum=180) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Победите маневром ферзя с шахом.';
Uroven:=1;
end;
if (partNum=181) then
begin
...
Moves := 'd8-h4';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Белые в матовой клетке. Пункт f2 слаб';
Uroven:=1;
end;
if (partNum=182) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте угрозу проведения пешки a в ферзи.';
Uroven:=1;
end;
if (partNum=185) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте вилку и слабость первой горизонтали.';
Uroven:=1;
end;
if (partNum=186) then
begin
...
Moves := 'a4-d7';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Разбейте гармонию черных промежуточным ходом.';
Uroven:=1;
end;
if (partNum=187) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь клеткой для белой ладьи.';
Uroven:=1;
end;
if (partNum=188) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь неуклюжестью ферзя черных.';
Uroven:=1;
end;
if (partNum=189) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отвлеките ферзя белых от защиты своего короля';
Uroven:=1;
end;
if (partNum=192) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Предотвратите подключение ферзя к защите короля маневром пешки f, а потом матуйте.';
Uroven:=1;
end;
if (partNum=193) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант. Сделайте ничью';
Comment2:='Откройте короля черных для вечного шаха.';
Uroven:=1;
end;
if (partNum=195) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант. Сделайте ничью.';
Comment2:='Воспользуйтесь идеями пата и тем что поле h8 черное при белопольном слоне.';
Uroven:=1;
end;
if (partNum=196) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Выловите черного ферзя.';
Uroven:=1;
end;
if (partNum=197) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Проведите пешку f в ферзи.';
Uroven:=1;
end;
if (partNum=198) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь неуклюжестью ферзя черных, отвлеките его.';
Uroven:=1;
end;
if (partNum=199) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Обнаружьте выигрывающий маневр коня.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите жертву ладьи для завлечения под мат.';
Uroven:=1;
end;
if (partNum=202) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отвлеките защитника поля d2, для вторжения туда ладьи черных.';
Uroven:=1;
end;
if (partNum=203) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Активизируйте слона, чтобы не перекрыли второго слона.';
Uroven:=1;
end;
if (partNum=204) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Сплетите матовую сеть тяжелыми фигурами черных.';
Uroven:=1;
end;
if (partNum=205) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Король белых в клетке. Так хочется дать шах ферзем на f1.';
Uroven:=1;
end;
if (partNum=206) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Осуществите жертву ладьи.';
Uroven:=1;
end;
if (partNum=207) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая атака с жертвой ладьи.';
Uroven:=1;
end;
if (partNum=209) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат переводами ферзя.';
Uroven:=1;
end;
if (partNum=210) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Проведите пешку e в ферзи.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Поставьте вилку, используя связку.';
Uroven:=1;
end;
if (partNum=212) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Вытащите короля белых наружу из его скрытного убежища.';
Uroven:=1;
end;
if (partNum=214) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отыграйте фигуру, использовав завлечение под шах.';
Uroven:=1;
end;
if (partNum=215) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Заматуйте черных, используя жертву ферзя.';
Uroven:=1;
end;
if (partNum=216) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат на поле h7.';
Uroven:=1;
end;
if (partNum=217) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ладья на h8 без защиты.';
Uroven:=1;
end;
if (partNum=218) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Проведите пешку в ферзи, используя скрытый шах.';
Uroven:=1;
end;
if (partNum=219) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Ворвитесь тяжелыми фигурами на первую горизонталь.';
Uroven:=1;
end;
if (partNum=220) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Поставьте мат с жертвой ферзя.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат в 4 хода.';
Uroven:=1;
end;
if (partNum=222) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат в 3 хода.';
Uroven:=1;
end;
if (partNum=223) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Выиграйте ладью, разменяв ладьи оптимальным образом.';
Uroven:=1;
end;
if (partNum=225) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте надвинутость проходной пешки.';
Uroven:=1;
 end;
 if (partNum=226) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Остроумным маневром ладьи создайте матовые угрозы.';
Uroven:=1;
end;
if (partNum=227) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте то, что оба ферзя стоят на одной горизонтали.';
Uroven:=1;
end;
if (partNum=228) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Разрушьте прикрытие черного короля прямым ударом.';
Uroven:=1;
end;
if (partNum=229) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Иногда слоны лучше чем ладьи.';
Uroven:=1;
end;
if (partNum=230) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подключите ладью к атаке, используя связку ферзя.';
Uroven:=1;
end;
if (partNum=231) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь перекрытием.';
Uroven:=1;
end;
if (partNum=234) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Соорудите матовую сетку.';
Uroven:=1;
end;
if (partNum=238) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Выиграйте пешку отвлечением.';
Uroven:=1;
end;
if (partNum=241) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь слабостью белых полей и угрозой мата.';
Uroven:=1;
end;
if (partNum=242) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Поставьте вилку, используя угрозу пункту g2.';
Uroven:=1;
end;
if (partNum=244) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь беззащитностью ферзя a5.';
Uroven:=1;
 end;
  if (partNum=246) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Чтобы поставить мат, используйте отвлечение.';
Uroven:=1;
end;
if (partNum=247) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь тем, что ферзь и король белых стоят на одной диагонали.';
Uroven:=1;
end;
if (partNum=248) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Поставьте вилку на ферзя и короля.';
Uroven:=1;
end;
if (partNum=249) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отвлеките ферзя от защиты пункта g2.';
Uroven:=1;
end;
if (partNum=250) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Выиграйте, комбинируя матовые угрозы.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозой мата для выигрыша ладьи.';
Uroven:=1;
end;
if (partNum=252) then
begin
...
Moves := 'e2-c4';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте завлечение ладьи.';
Uroven:=1;
end;
if (partNum=253) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат с завлекающей жертвой.';
Uroven:=1;
end;
if (partNum=254) then
begin
...
Moves := 'd5-c5';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь слабостью первой горизонтали.';
Uroven:=1;
 end;
  if (partNum=256) then
begin
...
Moves := 'd5-e7';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите смелый прыжок скакуна.';
Uroven:=1;
end;
if (partNum=258) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Неожиданно подключите ладьи.';
Uroven:=1;
end;
if (partNum=259) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь слабостью 8-горизонтали.';
Uroven:=1;
end;
if (partNum=260) then
begin
...
Moves := 'e4-g6';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Создайте матовую угрозу.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозой мата для выигрыша.';
Uroven:=1;
end;
if (partNum=262) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Линия b очень опасна. Как для белых так и для черных.';
Uroven:=1;
end;
if (partNum=263) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Завлеките ферзя белых.';
Uroven:=1;
end;
if (partNum=265) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Вскройте позицию прямой жертвой.';
Uroven:=1;
 end;
  if (partNum=266) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мощную вилку.';
Uroven:=1;
end;
if (partNum=267) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите перекрытие для матового рейда короля.';
Uroven:=1;
end;
if (partNum=268) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Неожиданно заприте ладью.';
Uroven:=1;
end;
if (partNum=269) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь связкой короля черных.';
Uroven:=1;
end;
if (partNum=270) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Пожертвуйте ладью для матовой атаки.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозой мата для выигрыша и связкой.';
Uroven:=1;
end;
if (partNum=272) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отвлеките ладью с диагонали d.';
Uroven:=1;
end;
if (partNum=274) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отвлеките ферзя черных от защиты h7.';
Uroven:=1;
end;
if (partNum=275) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Завлеките короля под вилку.';
Uroven:=1;
 end;
  if (partNum=276) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Проведите матовую атаку по белым полям.';
Uroven:=1;
end;
if (partNum=277) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Осуществите перекрытие чтобы ладья не смогла задержать проходную пешку.';
Uroven:=1;
end;
if (partNum=278) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Конь и ладья могут удачно создавать матовые угрозы.';
Uroven:=1;
end;
if (partNum=280) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант. Сделайте ничью';
Comment2:='Сделайте ничью повторением ходов.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозой мата по первой горизонтали.';
Uroven:=1;
end;
if (partNum=282) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Вскройте позицию черного короля для создания угроз (матовой атаки и вилки).';
Uroven:=1;
end;
if (partNum=283) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант. Сделайте ничью.';
Comment2:='Сделайте ничью, сочетая идеи вечного шаха и пата.';
Uroven:=1;
end;
if (partNum=284) then
begin
...
Moves := 'd5-c3';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Скачок коня решит партию.';
Uroven:=1;
end;
if (partNum=285) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозами мата.';
Uroven:=1;
end;
if (partNum=287) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поля вокруг черного короля очень ослаблены. Разрушьте крепость.';
Uroven:=1;
end;
if (partNum=289) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозами мата и проведения пешки в ферзи.';
Uroven:=1;
end;
if (partNum=290) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь двойным шахом чтобы поставить мат.';
Uroven:=1;
end;
if (partNum=292) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Сплетите матовую сетку не дав выбраться королю по белым полям.';
Uroven:=1;
end;
if (partNum=294) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отвлеките ферзя от защиты слона d4.';
Uroven:=1;
end;
if (partNum=295) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Завлеките короля под вскрытый шах.';
Uroven:=1;
 end;
 if (partNum=296) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант. Сделайте ничью';
Comment2:='Воспользуйтесь угрозами мата и вскрытого нападения на ферзя чтобы сделать ничью.';
Uroven:=1;
end;
if (partNum=297) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поля вокруг черного короля очень ослаблены. Разрушьте крепость с матом.';
Uroven:=1;
end;
if (partNum=299) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Поставьте мат с жертвой ладьи.';
Uroven:=1;
end;
if (partNum=300) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Выиграйте качество пожертвовав коня.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозой линейного мата.';
Uroven:=1;
end;
if (partNum=302) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте линейный мат.';
Uroven:=1;
end;
if (partNum=303) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Выиграйте пожертвовав ферзя.';
Uroven:=1;
end;
if (partNum=304) then
begin
...
Moves := 'a2-a7';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Завлеките ферзя под удар.';
Uroven:=1;
end;
if (partNum=305) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат по белым полям.';
Uroven:=1;
end;
if (partNum=308) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Надо бороться с блокером на f6.';
Uroven:=1;
end;
if (partNum=309) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Заматуйте короля на h1.';
Uroven:=1;
end;
if (partNum=310) then
begin
...
Moves := 'd1-d8';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Возможно воспользоваться угрозой вилки.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь тем что слон на a4 без защиты.';
Uroven:=1;
end;
if (partNum=312) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Избавьтесь от связки, шахами завлекая короля белых в матовую сетку.';
Uroven:=1;
end;
if (partNum=313) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Выиграйте ферзя вилкой.';
Uroven:=1;
end;
if (partNum=314) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подключите к атаке решающим образом белопольного слона.';
Uroven:=1;
end;
if (partNum=315) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите атаку по черным полям.';
Uroven:=1;
 end;
  if (partNum=316) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Неожиданный шах поможет выиграть ладью.';
Uroven:=1;
end;
if (partNum=317) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Заманите ферзя черных под связку.';
Uroven:=1;
end;
if (partNum=318) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Заматуйте короля на g2.';
Uroven:=1;
end;
if (partNum=320) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте спертый мат.';
Uroven:=1;
end;
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Нарушьте координацию фигур белых.';
Uroven:=1;
end;
if (partNum=323) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите матовую атаку по черным полям.';
Uroven:=1;
 end;
   if (partNum=326) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Жертва коня приводит черных к успеху.';
Uroven:=1;
end;
if (partNum=328) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь связкой ферзя.';
Uroven:=1;
end;
if (partNum=329) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Организуйте угрозу мата по черным полям.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь тем что слон на f6 без защиты.';
Uroven:=1;
end;
if (partNum=333) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Поставьте мат на g2, с темпами убирая фигуры с линии g.';
Uroven:=1;
end;
if (partNum=334) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Разрушьте прикрытие черного короля подключая, вторую ладью к атаке.';
Uroven:=1;
end;
if (partNum=335) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Осуществляя ходы с темпами, выиграйте фигуру.';
Uroven:=1;
 end;
 if (partNum=337) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Подключите слона к атаке по черным полям.';
Uroven:=1;
end;
if (partNum=338) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Пожертвуйте коня, подключая ладьи в атаку.';
Uroven:=1;
end;
if (partNum=339) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь плохой защищенностью коня черных.';
Uroven:=1;
end;
if (partNum=340) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Заматуйте, переведя коня на d6.';
Uroven:=1;
end;
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Избавьтесь от защитника ферзя.';
Uroven:=1;
end;
if (partNum=342) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Соорудите матовые угрозы с помощью жертвы ладьи.';
Uroven:=1;
end;
if (partNum=343) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Вытащите черного короля наружу предложив ему ладью.';
Uroven:=1;
end;
if (partNum=344) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Матовая сетка сплетена, осталось подключить ладью.';
Uroven:=1;
end;
if (partNum=345) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте мат, пожертвовав ферзя.';
Uroven:=1;
 end;
 if (partNum=347) then
begin
...
Moves := 'e6:h6';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используйте вскрытое нападение.';
Uroven:=1;
end;
if (partNum=348) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Пожертвуйте ферзя с атакой.';
Uroven:=1;
end;
if (partNum=350) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Завлеките короля под шах, а ладью отвлеките от поля превращения белй пешки.';
Uroven:=1;
end;
if (partNum=351) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ориентируйтесь на линейный мат.';
Uroven:=1;
end;
if (partNum=352) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь идеей коневой вилки на поле e6.';
Uroven:=1;
end;
if (partNum=353) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Король черных необеспечен. Вскройте позицию в пункте e6.';
Uroven:=1;
end;
if (partNum=354) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Спертый мат и оганиченность белого ферзя - ключевые факторы.';
Uroven:=1;
end;
if (partNum=355) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Завлеките короля в угол под матовую атаку.';
Uroven:=1;
 end;
  if (partNum=356) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Проведите пешку в ферзи, перекрыв главную диагональ.';
Uroven:=1;
 end;
 if (partNum=357) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Освободите дорогу проходной.';
Uroven:=1;
end;
if (partNum=358) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Создайте угрозу мата ферзем и конем.';
Uroven:=1;
end;
if (partNum=359) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте вилку на е6, но сначала сделайте подготовительный скачок конем.';
Uroven:=1;
end;
if (partNum=360) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Сыграйте на связке ферзя.';
Uroven:=1;
end;
if (partNum=361) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Единственными ходами с шахами черные ставят мат.';
Uroven:=1;
end;
if (partNum=362) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Белые обладают красивым вскрытым шахом. Но у черных в ответ тоже есть красивый шах.';
Uroven:=1;
end;
if (partNum=363) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Решающее вторжение белой ладьи.';
Uroven:=1;
end;
if (partNum=364) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Вытаскивайте короля наружу с жертвами.';
Uroven:=1;
end;
if (partNum=365) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отвлеките короля от поля превращения проходной пешки.';
Uroven:=1;
 end;
  if (partNum=366) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ферзь и ладья черных далеко от короля. Вскройте его пешечное прекрытие.';
Uroven:=1;
 end;
 if (partNum=367) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Черные поля вокруг черного короля ослаблены. Соорудите матовую клетку.';
Uroven:=1;
end;
if (partNum=368) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подрубите две подпорки из под пункта g6.';
Uroven:=1;
end;
if (partNum=369) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ферзь черных отдален от короля и слаба 8-ая горизонталь.';
Uroven:=1;
end;
if (partNum=370) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Многоходовая атака по черным полям с жертвой коня.';
Uroven:=1;
end;
if (partNum=371) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Помешайте ладье черных остановить проходную.';
Uroven:=1;
end;
if (partNum=372) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь полем e5 для атаки белого ферзя.';
Uroven:=1;
end;
if (partNum=373) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Решающее вторжение по черным полям на черного короля.';
Uroven:=1;
end;
if (partNum=374) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Вытаскивайте короля наружу с атакой по черным полям.';
Uroven:=1;
 end;
  if (partNum=376) then
begin
...
Moves := 'd4-e6';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Сместите черную пешку для атаки по слабым белым полям.';
Uroven:=1;
 end;
 if (partNum=377) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Подключите решающим образом черную ладью.';
Uroven:=1;
end;
if (partNum=378) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Подключите ладью черных к атаке.';
Uroven:=1;
end;
if (partNum=379) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая атака с жертвой ферзя.';
Uroven:=1;
end;
if (partNum=380) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Выиграть пешку, перейти в эндшпиль.';
Uroven:=1;
end;
if (partNum=381) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Прямая матовая атака с жертвой ладьи.';
Uroven:=1;
end;
if (partNum=382) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Прямая атака с жертвой ферзя.';
Uroven:=1;
end;
if (partNum=383) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отвлеките ферзя от защиты пункта f3.';
Uroven:=1;
end;
if (partNum=384) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Надо сохранить атакующую ладью.';
Uroven:=1;
end;
if (partNum=385) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Откройте слону дорогу к пункту h2.';
Uroven:=1;
 end;
  if (partNum=386) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Слон на e8 в опасном положении.';
Uroven:=1;
 end;
 if (partNum=387) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ферзь черных очень ограничен.';
Uroven:=1;
end;
if (partNum=388) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Фигуры черных раскоординированы. Воспользуйтесь беззащитностью ладьи b8.';
Uroven:=1;
end;
if (partNum=389) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Матовая атака по черным полям с жертвой ладьи.';
Uroven:=1;
end;
if (partNum=391) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Король черных в опасности по 8-ой горизонтали.';
Uroven:=1;
end;
if (partNum=392) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Обратите внимание, что ладья на b8, попадает под удар слона с e5.';
Uroven:=1;
end;
if (partNum=393) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Мат в три хода с жертвой ферзя.';
Uroven:=1;
end;
if (partNum=395) then
begin
...
Moves := 'd8-h4';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Неожиданно подключите ферзя в атаку.';
Uroven:=1;
 end;
if (partNum=396) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Атака по ослабленным белым полям.';
Uroven:=1;
 end;
 if (partNum=397) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Отыграть пожертванную фигуру, сохранив пешечный перевес. Для этого необходимо активизировать ладьи.';
Uroven:=1;
end;
if (partNum=398) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Все решит идея превращения проходной пешки.';
Uroven:=1;
end;
if (partNum=399) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Атака с жертвой ладьи.';
Uroven:=1;
end;
if (partNum=400) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая атака с жертвой коня.';
Uroven:=1;
end;
if (partNum=401) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Король черных в опасности, подключите ладью, а потом ферзя.';
Uroven:=1;
end;
if (partNum=402) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Создайте матовые угрозы по линии h.';
Uroven:=1;
end;
if (partNum=403) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:=' Для атаки уничтожьте защитника обороны черных слона.';
Uroven:=1;
end;
if (partNum=405) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Заприте короля в клетку и подключите ферзя.';
Uroven:=1;
 end;
 if (partNum=406) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Подключите для атаки ладью по линии h.';
Uroven:=1;
 end;
 if (partNum=407) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая атака. Позиция черных трещит по белым полям.';
Uroven:=1;
end;
if (partNum=408) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='К выигрышу на связке ведет только одно отступление ферзя.';
Uroven:=1;
end;
if (partNum=409) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ладья и ферзь решающим образом подключаются к атаке на короля.';
Uroven:=1;
end;
if (partNum=410) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант. Сделайте ничью.';
Comment2:='Король черных в опасности. Сделайте ничью патом.';
Uroven:=1;
end;
if (partNum=411) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите отвлечение, ведь король без форточки.';
Uroven:=1;
end;
if (partNum=412) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Завлеките белых под линейный мат.';
Uroven:=1;
end;
if (partNum=413) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Подключите к атаке дальнобойных слонов.';
Uroven:=1;
end;
if (partNum=414) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:=' Осуществите перевод коня для атаки на пункт g7.';
Uroven:=1;
end;
if (partNum=415) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Используя жертву слона, доберитесь до короля черных.';
Uroven:=1;
 end;
 if (partNum=416) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Нападение на ферзя с темпом. Выигрыш фигуры.';
Uroven:=1;
 end;
 if (partNum=417) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Белый король в мышеловке. Используйте отвлечение.';
Uroven:=1;
end;
if (partNum=418) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Жертва ладьи ведет к матовой атаке.';
Uroven:=1;
end;
if (partNum=419) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Жертва ферзя в нужный момент приведет к мату.';
Uroven:=1;
end;
if (partNum=420) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Мат в четыре хода с жертвами.';
Uroven:=1;
end;
if (partNum=422) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Белые отрезают ферзя от защиты черного короля.';
Uroven:=1;
end;
if (partNum=424) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь идеей линейного мата.';
Uroven:=1;
end;
if (partNum=425) then
begin
...
Moves := 'e4:e3';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Позиция белых трещит в следствие замкунотости клетки их короля.';
Uroven:=1;
 end;
 if (partNum=427) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Используйте отвлечение ферзя.';
Uroven:=1;
end;
if (partNum=428) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Воспользуйтесь угрозой мата по 8-ой горизонтали.';
Uroven:=1;
end;
if (partNum=431) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Жертва коня и ферзя ведет к матовой атаке.';
Uroven:=1;
end;
if (partNum=432) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Решает смелая жертва ферзя.';
Uroven:=1;
end;
if (partNum=433) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Король без форточки. Мат по 8-ой.';
Uroven:=1;
end;
if (partNum=434) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Жертвой качества белые осуществили выигрыш пешки.';
Uroven:=1;
 end;
 if (partNum=437) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отступление ферзя решает.';
Uroven:=1;
end;
if (partNum=438) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ограниченное положение короля позволяет поставить мат, прибегнув к жертве ферзя.';
Uroven:=1;
end;
if (partNum=439) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Жертва слона разрушает последний оплот короля.';
Uroven:=1;
end;
if (partNum=440) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите жертву ферзя.';
Uroven:=1;
end;
if (partNum=441) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подключите ладью к атаке по линии h.';
Uroven:=1;
end;
if (partNum=442) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Прорвитесь через слабый пункт g6.';
Uroven:=1;
end;
if (partNum=443) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Прорыв через пункт h7.';
Uroven:=1;
end;
if (partNum=444) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите стандартную комбинацию мельница.';
Uroven:=1;
end;
if (partNum=445) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подведите к королю ферзя для создания матовых угроз, используя связку.';
Uroven:=1;
 end;
 if (partNum=446) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Жертвой ферзя и матовая атака.';
Uroven:=1;
 end;
 if (partNum=447) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Ферзь перегужен защитой ладьи на e1. Воспользуйтесь этим.';
Uroven:=1;
end;
if (partNum=448) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Поставьте вилку с поля g4.';
Uroven:=1;
end;
if (partNum=449) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Жертва ферзя очень опасна для самочувствия белых.';
Uroven:=1;
end;
if (partNum=450) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Угроза проведения пешки h в ферзи решает.';
Uroven:=1;
end;
if (partNum=451) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подключите ферзя к атаке.';
Uroven:=1;
end;
if (partNum=452) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Стандартная комбинация с матовыми угрозами по линии h.';
Uroven:=1;
end;
if (partNum=454) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Серия форсированных ходов с шахами приводит к мату.';
Uroven:=1;
end;
if (partNum=455) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая конструкция вокруг короля черных должна помочь белым.';
Uroven:=1;
 end;
 if (partNum=456) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Завлечение и отвлечение помогут выиграть ферзя.';
Uroven:=1;
 end;
 if (partNum=457) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Осуществите переход в выигранный пешечный эндшпиль с лишней пешкой.';
Uroven:=1;
end;
if (partNum=458) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Форсированный матовый вариант, начинающийся с жертвы ладьи.';
Uroven:=1;
end;
if (partNum=459) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Неожиданный скачок коня поможет создать угрозу спертого мата.';
Uroven:=1;
end;
if (partNum=460) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая конструкция создается с помощью жертвы ферзя.';
Uroven:=1;
end;
if (partNum=461) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Два коня преносятся в жертву ради атаки.';
Uroven:=1;
end;
if (partNum=462) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Конь на c5 провисает связанным, воспользуйтесь этим.';
Uroven:=1;
end;
if (partNum=464) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Переход разменами в выигранный пешечный эндшпиль.';
Uroven:=1;
end;
if (partNum=465) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Для движения пешки в ферзи следует выбить преграду с e7.';
Uroven:=1;
 end;
  if (partNum=466) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отвлечение ферзя от защиты пешки.';
Uroven:=1;
 end;
 if (partNum=467) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Неустойчивость слона на d5 ведет к проигрышу качества.';
Uroven:=1;
end;
if (partNum=468) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Смелая жертва ладьи решает.';
Uroven:=1;
end;
if (partNum=470) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая конструкция создается с помощью жертвы ферзя и подключения пешки.';
Uroven:=1;
end;
if (partNum=471) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ферзь черных висит на волоске. Но необходима жертва ладьи чтобы сьесть его.';
Uroven:=1;
end;
if (partNum=472) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='В позиции имеется форсированный мат.';
Uroven:=1;
end;
if (partNum=473) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Форсированный мат с жертвой ферзя.';
Uroven:=1;
end;
if (partNum=475) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Жертва ферзя приводит к преимуществу.';
Uroven:=1;
 end;
   if (partNum=476) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Матовая комбинация с жертвой главной фигуры.';
Uroven:=1;
 end;
 if (partNum=477) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Комбинация основана на связке слона.';
Uroven:=1;
end;
if (partNum=478) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Решает угроза проведения пешки в ферзи.';
Uroven:=1;
end;
if (partNum=479) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Белые выигрываю на идеи линейного мата.';
Uroven:=1;
end;
if (partNum=480) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Ладья черных застряла в атаке, воспользуйтесь этим.';
Uroven:=1;
end;
if (partNum=481) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='С помощью коней атакуйте белого ферьзя.';
Uroven:=1;
end;
if (partNum=482) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Отвлечение слона решает.';
Uroven:=1;
end;
if (partNum=483) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Заберите ладью попавшую в ловушку королем.';
Uroven:=1;
end;
if (partNum=484) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Подключение ладьи c решает.';
Uroven:=1;
end;
if (partNum=485) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Пешечный тычок решает.';
Uroven:=1;
 end;
   if (partNum=486) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Проведите пешку в ферзи, воспользовавшись отвлечением ладьи.';
Uroven:=1;
end;
if (partNum=488) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Мат в три хода с жертвой двух фигур.';
Uroven:=1;
end;
if (partNum=489) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Выиграйте качество, воспользовавшись беззащитностью ладьи на b1.';
Uroven:=1;
end;
if (partNum=491) then
begin
...
Moves := 'c6-e4';
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Слабость первой горизонтали.';
Uroven:=1;
end;
if (partNum=492) then
begin
...
Moves := 'e5:d6';
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Слабость восьмой горизонтали.';
Uroven:=1;
end;
if (partNum=495) then
begin
...
Comment:= 'Ход белых. Найдите оптимальный вариант.';
Comment2:='Спертое положение короля.';
Uroven:=1;
end;
if (partNum=525) then
begin
...
Comment:= 'Ход черных. Найдите оптимальный вариант.';
Comment2:='Спертое положение ферзя.';
Uroven:=1;
end;
if (partNum=592) then
begin
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Проходная скажет свое слово.';
Uroven:=1;
end;
if (partNum=652) then
begin
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Жертва чтобы добратьcя до неприятельского короля.';
Uroven:=1;
end;
if (partNum=653) then
begin
...
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Жертва чтобы добратьcя до неприятельского короля.';
Uroven:=1;
end;
if (partNum=654) then
...
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Проходная пешка решает.';
Uroven:=1;
end;
if (partNum=658) then
begin
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Разменная операция с выигрышем фигуры.';
Uroven:=1;
end;
if (partNum=663) then
begin
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Необеспеченность черного короля решает.';
Uroven:=1;
end;
if (partNum=665) then
begin
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Ладьям белых надо добраться до короля.';
Uroven:=1;
end;
if (partNum=669) then
begin
...
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Необеспеченность безопасности первой горизонтали.';
Uroven:=1;
end;
if (partNum=670) then
begin
...
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Отвлечение фигуры от защиты короля.';
Uroven:=1;
...
Moves := 'e8-e1 d2:e1 d3-b2';
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Поохотьтесь за ферзем белых.';
Uroven:=1;
end;
if (partNum=678) then
begin
...
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Черный ферзь сильно окружен.';
Uroven:=1;
end;
if (partNum=681) then
begin
...
Moves := 'f6-g4 g5:e7 d8-b6 g1-h1 g4-f2 h1-g1 d4-e2';
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Воспользуйтесь угрозой выигрыша ферзя и спертого мата.';
Uroven:=1;
end;
if (partNum=682) then
begin
...
Comment:= 'Ход черных. Найти оптимальный вариант. Сделайте ничью.';
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Ладья черных без защиты, да и король слабоват.';
Uroven:=1;
end;
if (partNum=684) then
begin
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Рассматривайте мотивы вилки.';
Uroven:=1;
end;
if (partNum=685) then
begin
...
Comment:= 'Ход белых. Найти оптимальный вариант. Сделайте ничью.';
Comment2:='Игра на пат.';
Uroven:=1;
end;
if (partNum=690) then
...
Comment:= 'Ход белых. Найти оптимальный вариант.';
Comment2:='Конь черных застрял на отшибе.';
Uroven:=1;
end;
if (partNum=692) then
begin
...
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Жертва чтобы провести пешку в ферзя.';
Uroven:=1;
end;
if (partNum=696) then
begin
...
Comment:= 'Ход черных. Найти оптимальный вариант.';
Comment2:='Используйте идею вилки.';
Uroven:=1;
end;
if (partNum=700) then
begin
