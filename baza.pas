...
begin
  ...
  if radiobutton1.Checked then
   begin
   baza1:=1;
   form1.Caption:='AmfitelOs Тактика'
   end;
  if radiobutton2.Checked then
   begin
   baza1:=2;
   form1.Caption:='AmfitelOs Стратегия'
   end;
   if radiobutton3.Checked then
   begin
     form1.Caption:='AmfitelOs Комментированные партии' ;
     form8.show;
   end;
     if radiobutton4.Checked then
   begin
      baza1:=3;
     form1.Caption:='AmfitelOs Эндшпиль' ;
   end;
...
begin
  ...
  try
   try
    ...
    MessageDlg('Ошибка считывания данных!',mtError,[mbYes],0) ;
    end;
end;
